...
#define SPI_CS_GPIO_CLK 		    RCC_AHBPeriph_GPIOC

#define LORA_INT1_PIN			      GPIO_Pin_1
...
#define LORA_TXEN_GPIO_PIN			GPIO_Pin_5
#define LORA_TXEN_GPIO_PORT     GPIOC
#define LORA_TXEN_GPIO_CLK			RCC_AHBPeriph_GPIOC
...
#define  PA_TXD_OUT()    GPIO_SetBits( LORA_TXEN_GPIO_PORT, LORA_TXEN_GPIO_PIN );\
												 GPIO_ResetBits( LORA_RXEN_GPIO_PORT, LORA_RXEN_GPIO_PIN );                                          
#define  PA_RXD_OUT()    GPIO_ResetBits( LORA_TXEN_GPIO_PORT, LORA_TXEN_GPIO_PIN );\
												 GPIO_SetBits( LORA_RXEN_GPIO_PORT, LORA_RXEN_GPIO_PIN );
...
static void Lora_GPIO_Config(void){
  ...
  GPIO_InitStructure.GPIO_Pin   = LORA_TXEN_GPIO_PIN ;
  GPIO_Init( LORA_TXEN_GPIO_PORT, &GPIO_InitStructure );
	
	GPIO_InitStructure.GPIO_Pin   = LORA_RXEN_GPIO_PIN ;
  GPIO_Init( LORA_RXEN_GPIO_PORT, &GPIO_InitStructure );
